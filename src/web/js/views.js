...
totalGridView.prototype.run=function()
{
    ...
    var origen=['td#aperturaMov','td#aperturaClaro','td#trafico','td#recargaMov','td#recargaClaro','td#montoDeposito','td#otrosServicios','td#totalVentas','td#montoBanco','td#diferencialBancario','td#concilicacionBancaria','td#recargasVentasMovistar','td#diferencialBrightstarMovistar','td#recargasVentasClaro','td#diferencialBrightstarClaro','td#diferencialBrightstarDirecTv','td#diferencialBrightstarNextel','td#minutos','td#traficoCapturaDollar','td#traficoCapturaSoles','td#diferencialCapturaSoles','td#diferencialCapturaDollar','td#acumulado','td#sobrante','td#sobranteAcum','td#totalVentaPronostico','td#ventaMaxima','td#comision','td#saldo','td#nuevoSaldo'];
    ...
    var mensaje=['Saldo Apertura (S/.)','Saldo Apertura Claro','Trafico (S/.)','Servicios Movistar (S/.)','Servicios Claro (S/.)','Servicios DirecTv (S/.)','Servicios Nextel (S/.)','Monto Deposito (S/.)','Otros Servicios (S/.)','Total Ventas (S/.)','Monto Banco (S/.)','Diferencial Bancario (S/.)','Conciliación Bancaria (S/.)','Recarga Ventas Movistar (S/.)','Diferencial Movistar (S/.)','Recarga Ventas Claro (S/.)','Diferencial Claro (S/.)','Minutos segun Captura','Trafico Captura (USD $)','Capt Soles','Diferencial Captura Soles (S/.)','Diferencial Captura Dollar (USD $)','Acumulado Dif. Captura (USD $)','Sobrante (USD $)','Sobrante Acumulado (USD $)','Total Venta', 'Venta Maxima','Comision','Saldo','Total Nuevo Saldo'];
