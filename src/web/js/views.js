...
totalGridView.prototype.run=function()
{
    ...
    var destino=['td#vistaAdmin1','td#vistaAdmin2','td#totalTrafico','td#totalRecargaMov','td#totalRecargaClaro','td#totalServDirecTv','td#totalServNextel','td#totalMontoDeposito','td#balanceTotalesVentas4','td#totalVentas2','td#balanceTotalesDepositos3','td#totalDiferencialBancario','td#totalConcilicacionBancaria','td#balanceTotalesBrightstar1','td#totalesDiferencialBrightstarMovistar','td#balanceTotalesBrightstar3','td#totalesDiferencialBrightstarClaro','td#totalMinutos','td#balanceTotalesCaptura1','td#balanceTotalesCaptura2','td#totalesDiferencialCapturaSoles','td#totalesDiferencialCapturaDollar','td#totalAcumulado','td#totalSobrante','td#totalSobranteAcum','td#TotalVentasPronostico','td#totalVentaMaxima','td#totalComision','td#totalSaldo','td#totalNuevoSaldo'];
