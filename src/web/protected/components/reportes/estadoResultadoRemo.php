...
//            $mes = date("m", strtotime($fecha));
            ...
            if($modelAcum == NULL){
                ...
                $totalMonto =  $totalMonto + round((($modelAcum->DiferencialBancario+$modelAcum->DiferencialMovistar+$modelAcum->DiferencialClaro+$modelAcum->DiferencialNextel+$modelAcum->DiferencialDirectv+($modelAcum->DiferencialCaptura*$paridad))/$paridad),2);
            }
...
//            $objPHPExcel->getActiveSheet()->getRowDimension('41')->setRowHeight(0);  
            ...
            foreach (array_reverse($mes_array,true) as $key => $value){
                    ...
                    $servDirecTvDollar = ($servDirecTv);
                    $servNextelDollar = ($servNextel);
                    $subArriendoDollar =($subArriendo);
