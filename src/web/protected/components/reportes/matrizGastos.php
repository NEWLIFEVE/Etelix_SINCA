...
//                                $opago.="<td></td>";
                                ...
                                $opago.="<td rowspan='1' style='width: 80px; background: #ff9900'><h3 style='font-size:10px; color:#FFFFFF; background: none; text-align: center;'>".htmlentities($gasto->nombreTipoDetalle)."</h3></td>";
//                                $opago.="<td ></td>";
//                                $opago.="<td></td>";
                                $opago.="<td style='width: 80px;color: #FFF; $fondo; font-size:10px;'>$MontoGasto->Monto $moneda</td>";
                            }
                    ...
                    if ($count>0){
                        ...
                        $opago.="<td rowspan='1' style='width: 80px; background: #ff9900'><h3 style='font-size:10px; color:#FFFFFF; background: none; text-align: center;'>".htmlentities($gasto->nombreTipoDetalle)."</h3></td><td></td>";
                    }
...
//    </tr>";
    ...
    $tr.= "<tr>
            ...
            <td rowspan='1' style='color: #FFF;width: 80px; background: #ff9900;font-size:10px;'><h3 style='font-size:10px; color:#FFFFFF; background: none; text-align: center;'>Totales S/.</h3></td>
            ";
    ...
    $tr.= "<tr>
            ...
            <td rowspan='1' style='color: #FFF;width: 80px; background: #ff9900;font-size:10px;'><h3 style='font-size:10px; color:#FFFFFF; background: none; text-align: center;'>Totales USD$</h3></td>
            ";
