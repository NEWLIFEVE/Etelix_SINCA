...
class EAjaxUpload extends CWidget
{
	...
	public $css=null;
		...
		{
		      throw new CException('EAjaxUpload: parametro "action" no puede estar vacio.');
                }

		if(empty($this->config['allowedExtensions']))
		{
		      throw new CException('EAjaxUpload: parametro "allowedExtensions" no puede estar vacio.');
                }

		if(empty($this->config['sizeLimit']))
		{
		      throw new CException('EAjaxUpload: parametro "sizeLimit" no puede estar vacio.');
                }

                unset($this->config['element']);

                echo '<div id="'.$this->id.'"><noscript><p>Por favor active JavaScript en su navegador para usar el cargador de archivos.</p></noscript></div>';
