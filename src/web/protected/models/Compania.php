 ...
 * @property Brightstar[] $brightstars
 */
class Compania extends CActiveRecord
{
    ...
    public static function getListCompania()
    {
    ...
    {
    	$criteria = new CDbCriteria;
    	$criteria->condition = 'Id=:compania_id';
    	$criteria->params = array(':compania_id' => $idCompania);
    	$resultSet = Compania::model()->find($criteria);
    	if(isset($resultSet))
    	{
