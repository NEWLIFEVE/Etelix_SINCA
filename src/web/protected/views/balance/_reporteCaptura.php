...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'CaptSoles',
            'value'=>'Yii::app()->format->formatDecimal(
                      $data->TraficoCapturaDollar*$data->pARIDAD->Valor
                      )',
            'type'=>'text',
            ),
        array(
            'name'=>'DifSoles',
            'value'=>'Yii::app()->format->formatDecimal(
                      ($data->FijoLocal+$data->FijoProvincia+$data->FijoLima+$data->Rural+$data->Celular+$data->LDI)-($data->TraficoCapturaDollar*$data->pARIDAD->Valor)
                      )',
            'type'=>'text',
            'htmlOptions'=>array(
                'style'=>'text-align: center;',
        ...
        array(
            'name'=>'DifDollar',
            'value'=>'Yii::app()->format->formatDecimal(
                      ($data->FijoLocal+$data->FijoProvincia+$data->FijoLima+$data->Rural+$data->Celular+$data->LDI-$data->TraficoCapturaDollar*$data->pARIDAD->Valor)/$data->pARIDAD->Valor
                      )',
            'type'=>'text',
            'htmlOptions'=>array(
                'style'=>'text-align: center;',
