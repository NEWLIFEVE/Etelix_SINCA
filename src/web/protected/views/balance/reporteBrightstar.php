...
<h1>
    <span class="enviar">
        Reporte de Ventas Recargas Brightstar
    </span> 
    <span>
...
echo CHtml::textField('vista', 'reporteBrightstar', array('id' => 'vista', 'style'=>'display:none'));
echo CHtml::textField('correoUsuario',Yii::app()->getModule('user')->user()->email,array('id'=>'email','style'=>'display:none'));
echo CHtml::textField('asunto', 'Reporte de Ventas Recargas Brightstar Solicitado', array('id' => 'asunto', 'style'=>'display:none'));
echo CHtml::endForm();
?>
