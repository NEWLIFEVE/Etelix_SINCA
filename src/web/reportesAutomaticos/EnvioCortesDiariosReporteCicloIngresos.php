...
/************************ SENTENCIAS SQL - COMIENZO *********************************/
    ...
    $sql = "SELECT
                ...
                TRUNCATE(( IFNULL(b.MontoBanco,0) - IFNULL(b.MontoDeposito,0) ),2)
                        AS 'Conciliacion Bancaria (S/.)',
                TRUNCATE(( IFNULL(b.RecargaVentasMov,0) - ( IFNULL(b.RecargaCelularMov,0) + IFNULL(b.RecargaFonoYaMov,0) ) ),2)
                        AS 'Diferencial Brightstar Movistar (S/.)',
                TRUNCATE(( IFNULL(b.RecargaVentasClaro,0) - ( IFNULL(b.RecargaCelularClaro,0) + IFNULL(b.RecargaFonoClaro,0) ) ),2)
            ...
            WHERE
                b.Fecha = CONCAT(YEAR(CURDATE()),'-0',MONTH(CURDATE()),'-',DAY(CURDATE())-1)
...
while ($filaTotal = mysql_fetch_row($resultadoTotal)){
    ...
    $email .= "
        <tr>
            <th style='background-color:#009900; color:white;'>$filaTotal[0]</th>
            ...
            <th style='background-color:#cc99cc; color:white;'>$filaTotal[7]</th>
